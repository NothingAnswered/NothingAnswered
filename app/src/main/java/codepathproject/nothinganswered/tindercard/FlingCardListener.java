package codepathproject.nothinganswered.tindercard;
...
public class FlingCardListener implements View.OnTouchListener {
    ...
    private ActionDownInterface listener;
    public void setActionDownListener(ActionDownInterface implementor){
