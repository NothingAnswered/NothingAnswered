 ...
 */
public class GaffeCamera {


    private static final String TAG = "GaffeCamera";
    ...
    public void StartCameraPreview(AutoFitTextureView textureView) {

        mTextureView = textureView;
        startBackgroundThread();
        if (mTextureView.isAvailable()) {
            Toast.makeText(context, "Is Available", Toast.LENGTH_SHORT).show();
        ...
        try {
            ...
            for(String cameraId : manager.getCameraIdList()){
                ...
                if(facing != null && facing == CameraCharacteristics.LENS_FACING_FRONT) {
                    ...
                    Toast.makeText(context, "FRONT CAMERA", Toast.LENGTH_SHORT).show();
